 ...
 */
export interface WebSitesSlotsProps extends IAzAPIBaseProps {
/**
   * Kind of resource.
   */
...
/**
 * WebSitesSlots resource
 */
export class WebSitesSlots extends AzAPIBase {
  constructor(scope: Construct, id: string, props: WebSitesSlotsProps) {
    super(scope, id, props);
  }

  protected getResourceType(): string {
    return "Microsoft.Web/sites/slots@2022-09-01";
  }

  protected getResourceBody(props: WebSitesSlotsProps): string {
