 ...
 */
export interface DocumentdbDatabaseaccountsCassandrakeyspacesThroughputsettingsProps extends IAzAPIBaseProps {
/**
...
/**
 * DocumentdbDatabaseaccountsCassandrakeyspacesThroughputsettings resource
 */
export class DocumentdbDatabaseaccountsCassandrakeyspacesThroughputsettings extends AzAPIBase {
  constructor(scope: Construct, id: string, props: DocumentdbDatabaseaccountsCassandrakeyspacesThroughputsettingsProps) {
    super(scope, id, props);
  }

  protected getResourceType(): string {
    return "Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings@2023-04-15";
  }

  protected getResourceBody(props: DocumentdbDatabaseaccountsCassandrakeyspacesThroughputsettingsProps): string {
