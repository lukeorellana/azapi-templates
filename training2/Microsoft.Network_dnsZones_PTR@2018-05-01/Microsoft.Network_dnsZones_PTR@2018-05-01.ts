 ...
 */
export interface NetworkDnszonesPtrProps extends IAzAPIBaseProps {
/**
...
/**
 * NetworkDnszonesPtr resource
 */
export class NetworkDnszonesPtr extends AzAPIBase {
  constructor(scope: Construct, id: string, props: NetworkDnszonesPtrProps) {
    super(scope, id, props);
  }

  protected getResourceType(): string {
    return "Microsoft.Network/dnsZones/PTR@2018-05-01";
  }

  protected getResourceBody(props: NetworkDnszonesPtrProps): string {
