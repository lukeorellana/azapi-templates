...
/**
   * Set the object type
   */
readonly actionType: CreateJobCreateMonitorInvokeBatchEndponumber;

/**
   * [Required] Specifies the action type of the schedule
   */
readonly actionType: 'CreateJob';

/**
   * [Required] Defines Schedule action definition details.
   */
readonly jobDefinition: JobBaseProperties;
...
/**
   * [Required] Specifies the action type of the schedule
   */
readonly actionType: 'CreateMonitor';

/**
   * [Required] Defines the monitor.
   */
readonly monitorDefinition: MonitorDefinition;

/**
   * The monitor's notification settings.
   */
readonly alertNotificationSettings?: MonitorNotificationSettings;

/**
   * [Required] The ARM resource ID of the compute resource to run the monitoring job on.
   */
readonly computeConfiguration: MonitorComputeConfigurationBase;

/**
   * The entities targeted by the monitor.
   */
readonly monitoringTarget?: MonitoringTarget;

/**
   * [Required] The signals to monitor.
   */
readonly signals: MonitorDefinitionSignals;

/**
   * The AML notification email settings.
   */
readonly emailNotificationSettings?: MonitorEmailNotificationSettings;
...
/**
   * Set the object type
   */
readonly computeType: ServerlessSpark;
...
/**
   ...
   */
readonly computeIdentity: MonitorComputeIdentityBase;

/**
   * [Required] The instance type running the Spark job.
   */
readonly instanceType: string Constranumbers:Min length = 1Pattern =[a-zA-Z0-9_];

/**
   * [Required] The Spark runtime version.
   */
readonly runtimeVersion: string Constranumbers:Min length = 1Pattern =^[0-9]+\.[0-9]+$;

/**
   * Set the object type
   */
readonly computeIdentityType: AmlTokenManagedIdentity;

/**
   * [Required] Specifies the type of identity to use within the monitoring jobs.
   */
readonly computeIdentityType: 'AmlToken';

/**
   * [Required] Specifies the type of identity to use within the monitoring jobs.
   */
readonly computeIdentityType: 'ManagedIdentity';
...
/**
   * 
   */
readonly {customized property}?: MonitoringSignalBase;

/**
   * The current notification mode for this signal.
   */
readonly notificationTypes?: String array containing any of:'AmlNotification';

/**
   * Set the object type
   */
readonly signalType: CustomDataDriftDataQualityFeatureAttributionDriftPredictionDrift;
...
/**
   * [Required] Specifies the type of signal to monitor.
   */
readonly signalType: 'Custom';

/**
   * [Required] Reference to the component asset used to calculate the custom metrics.
   */
readonly componentId: string Constranumbers:Min length = 1Pattern =[a-zA-Z0-9_];

/**
   * Monitoring assets to take as input. Key is the component input port name, value is the data asset.
   */
readonly inputAssets?: CustomMonitoringSignalInputAssets;

/**
   * Extra component parameters to take as input. Key is the component literal input port name, value is the parameter value.
   */
readonly inputs?: CustomMonitoringSignalInputs;

/**
   * [Required] A list of metrics to calculate and their associated thresholds.
   */
readonly metricThresholds: CustomMetricThreshold[];

/**
   * 
   */
readonly {customized property}?: MonitoringInputDataBase;

/**
   * Mapping of column names to special uses.
   */
readonly columns?: MonitoringInputDataBaseColumns;
...
/**
   * Set the object type
   */
readonly inputDataType: FixedRollingStatic;
...
/**
   ...
   */
readonly metric: string Constranumbers:Min length = 1Pattern =[a-zA-Z0-9_];
...
/**
   * [Required] Specifies the type of signal to monitor.
   */
readonly signalType: 'DataDrift';

/**
   * A dictionary that maps feature names to their respective data types.
   */
readonly featureDataTypeOverride?: DataDriftMonitoringSignalFeatureDataTypeOverride;

/**
   * The settings for computing feature importance.
   */
readonly featureImportanceSettings?: FeatureImportanceSettings;

/**
   * The feature filter which identifies which feature to calculate drift over.
   */
readonly features?: MonitoringFeatureFilterBase;

/**
   * [Required] A list of metrics to calculate and their associated thresholds.
   */
readonly metricThresholds: DataDriftMetricThresholdBase[];

/**
   * [Required] The data which drift will be calculated for.
   */
readonly productionData: MonitoringInputDataBase;

/**
   * [Required] The data to calculate drift against.
   */
readonly referenceData: MonitoringInputDataBase;

/**
   * 
   */
readonly {customized property}?: 'Categorical''Numerical';
...
/**
   * Set the object type
   */
readonly filterType: AllFeaturesFeatureSubsetTopNByAttribution;

/**
   * [Required] Specifies the feature filter to leverage when selecting features to calculate metrics over.
   */
readonly filterType: 'AllFeatures';

/**
   * [Required] Specifies the feature filter to leverage when selecting features to calculate metrics over.
   */
readonly filterType: 'FeatureSubset';
...
/**
   * [Required] Specifies the feature filter to leverage when selecting features to calculate metrics over.
   */
readonly filterType: 'TopNByAttribution';
...
/**
   * Set the object type
   */
readonly dataType: CategoricalNumerical;

/**
   * [Required] Specifies the data type of the metric threshold.
   */
readonly dataType: 'Categorical';

/**
   * [Required] The categorical data drift metric to calculate.
   */
readonly metric: 'JensenShannonDistance''PearsonsChiSquaredTest''PopulationStabilityIndex';

/**
   * [Required] Specifies the data type of the metric threshold.
   */
readonly dataType: 'Numerical';

/**
   * [Required] The numerical data drift metric to calculate.
   */
readonly metric: 'JensenShannonDistance''NormalizedWassersteinDistance''PopulationStabilityIndex''TwoSampleKolmogorovSmirnovTest';

/**
   * [Required] Specifies the type of signal to monitor.
   */
readonly signalType: 'DataQuality';

/**
   * A dictionary that maps feature names to their respective data types.
   */
readonly featureDataTypeOverride?: DataQualityMonitoringSignalFeatureDataTypeOverride;
...
/**
   * [Required] A list of metrics to calculate and their associated thresholds.
   */
readonly metricThresholds: DataQualityMetricThresholdBase[];
...
/**
   ...
   */
readonly metric: 'DataTypeErrorRate''NullValueRate''OutOfBoundsRate';
...
/**
   * [Required] Specifies the type of signal to monitor.
   */
readonly signalType: 'FeatureAttributionDrift';

/**
   * A dictionary that maps feature names to their respective data types.
   */
readonly featureDataTypeOverride?: FeatureAttributionDriftMonitoringSignalFeatureDataTy...;
...
/**
   * [Required] A list of metrics to calculate and their associated thresholds.
   */
readonly metricThreshold: FeatureAttributionMetricThreshold;
...
/**
   ...
   */
readonly metric: 'NormalizedDiscountedCumulativeGain';
...
/**
   * [Required] Specifies the type of signal to monitor.
   */
readonly signalType: 'PredictionDrift';

/**
   * A dictionary that maps feature names to their respective data types.
   */
readonly featureDataTypeOverride?: PredictionDriftMonitoringSignalFeatureDataTypeOverri...;

/**
   * [Required] A list of metrics to calculate and their associated thresholds.
   */
readonly metricThresholds: PredictionDriftMetricThresholdBase[];
...
/**
   * [Required] Specifies the action type of the schedule
   */
readonly actionType: 'InvokeBatchEndponumber';

/**
   * [Required] Defines Schedule action definition details.{see href="TBD" /}
   */
readonly endpointInvocationDefinition: For Bicep, you can use theany()function.;
...
/**
   * Set the object type
   */
readonly triggerType: CronRecurrence;
...
/**
   ...
   */
readonly expression: string Constranumbers:Min length = 1Pattern =[a-zA-Z0-9_];
